---
name: memex-search
description: Search, filter, and retrieve Claude/Codex/Cursor/OpenCode/Pi/Copilot/OMP history indexed by the memex CLI. Use when you want to search history, run lexical/semantic/hybrid search, fetch full transcripts, or produce LLM-friendly JSON output.
---
